	...
	var Redactor = function(element, options)
	{
		...
		this.opts = $.extend({
			...
			modal_image_edit: String() +
				...
				'<label>The caption that will be displayed when someone hovers on the image:</label>' +
				'<input id="redactor_file_alt" class="redactor_input" />' +
				//'<label>' + RLANG.link + '</label>' +
				'<label>When someone clicks the image, link to:</label>' +
				...
				'<select id="redactor_form_image_align">' +
					...
					'<option value="none">No alignemnt</option>' +
